...
> Связанные материалы: [PROJECT.md](./PROJECT.md)
...
- Veles остаётся независимым Python/Streamlit-сервисом
...
- Несовместимо с типичным деплоем Streamlit на Linux-сервере
