...
| **Помощник бухгалтера** | После согласования всеми шестью загружает документ на оплату в банк-клиент |
...
Все **20 ЗПИФов** распределены между **тремя бухгалтерами**. У каждого бухгалтера на диске — папки только «своих» фондов; документ попадает в нужную папку на этапе сохранения бэк-офисом.
...
- [PROJECT.md](./PROJECT.md) — общий as-is / to-be процесс документооборота
- [INTEGRATION_DIADOC.md](./INTEGRATION_DIADOC.md) — интеграция с Diadoc API
